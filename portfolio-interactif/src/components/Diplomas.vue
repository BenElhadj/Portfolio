...
const diplomas = [
  {
    ...
    title: 'Ingénieur Expert en architecture des BDD et data',
  },
  {
    period: '2017 - 2019',
    institution: 'GRETA — Paris',
    title: 'BTS Systèmes Numériques, informatique et réseau',
  },
  {
    period: '2011 - 2013',
    institution: 'CSFIEE — Tunis',
    title: 'BTS en Production électronique',
  },
  {
    period: '2006 - 2008',
    institution: 'CSFIEE — Tunis',
    title: 'BAC Pro en fabrication électronique',
  },
  {
    period: '2003 - 2005',
    institution: 'IPH — Tunis',
    title: 'BAC Pro en maintenance informatique',
  },
];
